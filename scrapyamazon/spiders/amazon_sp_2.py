...
class AmazonSpiderSpider(scrapy.Spider):
    name = 'amazon_sp_2'
    page_number = 2
    url_link = "https://www.amazon.com/Books-Last-30-days/s?rh=n%3A283155%2Cp_n_publication_date%3A1250226011"
    ...
    def parse(self, response):
        ...
        for section in response.css('div.s-main-slot>div.sg-col-20-of-24.s-result-item.s-asin.sg-col-0-of-12'):           
            ...
            price_hardcover = section.xpath(".//div[./a[contains(text(),'Hardcover')]]/following-sibling::div//span[contains(@class,'a-offscreen')]/text()").get(default='unavailable')
            price_kindle = section.xpath(".//div[./a[contains(text(),'Kindle')]]/following-sibling::div//span[contains(@class,'a-offscreen')]/text()").get(default='unavailable')
        ...
        next_url = "https://www.amazon.com/Books-Last-30-days/s?i=stripbooks&rh=n%3A283155%2Cp_n_publication_date%3A1250226011&page="+str(AmazonSpiderSpider.page_number)+"&qid=1603647684&ref=sr_pg_"+str(AmazonSpiderSpider.page_number)
        next_page = 'http://api.scraperapi.com/?api_key='+ API_KEY + '&url=' + next_url + '&render=true'
